    ...
    async (authType: AuthType | undefined, scope: LoadableSettingScope) => {
      if (authType) {
        ...
        if (
          ...
          writeToStdout(`
----------------------------------------------------------------
Logging in with Google... Restarting Lemini CLI to continue.
----------------------------------------------------------------
          `);
  ...
  // Update terminal title with Lemini CLI status and thoughts
  useEffect(() => {
    ...
    // Note: We don't need to reset the window title on exit because Lemini CLI is already doing that elsewhere
  }, [
    streamingState,
    thought,
    settings.merged.ui?.showStatusInTitle,
