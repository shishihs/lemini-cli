  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Lemini CLI status and thoughts in the terminal window title',
        showInDialog: true,
      },
      hideTips: {
        type: 'boolean',
  ...
  tools: {
    ...
    properties: {
      ...
      enableHooks: {
        ...
        default: false,
        description:
          'Enable the hooks system for intercepting and customizing Lemini CLI behavior. When enabled, hooks configured in settings will execute at appropriate lifecycle events (BeforeTool, AfterTool, BeforeModel, etc.). Requires MessageBus integration.',
        showInDialog: false,
      },
    },
  },
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the Lemini CLI extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for Lemini CLI.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling Lemini CLI output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
